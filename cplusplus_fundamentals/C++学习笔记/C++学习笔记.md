...
![幕截图 2026-06-28 16465](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 164657.png)



- **值传递的时候，实参是不影响的   ；地址传递的时候，实参是受影响的**

![幕截图 2026-06-28 17075](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 170758.png)

![幕截图 2026-06-28 22410](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 224103.png)

- **指针常量 常量指针** 

![幕截图 2026-06-28 21441](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 214413.png)

![幕截图 2026-06-28 21454](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 214545.png)

![截图 2026-06-28 21470](D:\文件\嵌入式工作学习\C++学习笔记/屏幕截图 2026-06-28 214701.png)
...
![7feaec202164edc3424bd00961e686](D:\文件\嵌入式工作学习\C++学习笔记\e7feaec202164edc3424bd00961e6864.png)

- **引用的本质就是一个指针常量**

![7feaec202164edc3424bd00961e686](D:\文件\嵌入式工作学习\C++学习笔记/32f84a7c4695867a2fb77a8df64dafce.png)

- 函数重载：同一个作用域；函数名相同；函数参数类型或者个数或者顺利不同。提高复用性。
- 类和对象的访问权限：public protected private

![78314409453](D:\文件\嵌入式工作学习\C++学习笔记\1783144094535.png)
...
![78323833867](D:\文件\嵌入式工作学习\C++学习笔记\1783238338676.png)
...
![78324030990](D:\文件\嵌入式工作学习\C++学习笔记\1783240309904.png)

- this指针：this指针指向被调用的成员函数所属的对象

![78325006897](D:\文件\嵌入式工作学习\C++学习笔记\1783250068974.png)
...
- 继承好处：减少重复代码
  ...
  ![78340807391](D:\文件\嵌入式工作学习\C++学习笔记\1783408073916.png)


- **菱形继承：虚继承（底层是虚基类指针加上相对应的偏移量）**

![78347570385](D:\文件\嵌入式工作学习\C++学习笔记\1783475703858.png)

![78347564399](D:\文件\嵌入式工作学习\C++学习笔记\1783475643994.png)
